...
user1 = User.create(first_name: "Nico", last_name: "Reyes", email_address: "nico@gmail.com")
# user2 = User.create(first_name: "Nunny", last_name: "Reyes", email_address: "nunny@gmail.com")
